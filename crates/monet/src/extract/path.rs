...
//         match T::deserialize(PathDeserializer::new(get_url_params(parts)?)) {
//             Ok(val) => Ok(Self(val)),
...
// }
//
// fn get_url_params(parts: &Parts) -> Result<&[(Arc<str>, Arc<str>)], crate::Error> {
...
//                 },
//             };
//             Err(crate::Error::FailedToDeserializePathParams)
//         }
